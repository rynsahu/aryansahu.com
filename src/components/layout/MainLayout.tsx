        ...
        <div className="container py-8 px-4 flex flex-col">
            <header className="flex flex-col gap-4">
                ...
                <h1 className="text-2xl color-primary font-medium">
                    ...
                    <Link to="https://linkedin.com/in/rynsahu" target="_blank" className="color-primary font-normal hover-underline">@rynsahu</Link>
                </h1>
                {/* Navigation */}
            ...
            <footer className="flex flex-col items-center gap-4 text-sm color-quaternary mb-2">
                ...
                <div className="text-center">
                    <p>Built by yours truly. Here's the <Link to="https://github.com/rynsahu" className="color-primary underline">code</Link>.</p>
                    <p>Website heavily inspired by Akash Bhadange</p>
                </div>
            </footer>
        </div>
    )
