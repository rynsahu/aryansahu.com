...
function Card({ children, link, className = "", onClick }) {
...
function InfoCard({ direction = "row", heading, icon, text, className = "", subHeading, headerWrapperClass = "", iconShadow = "", link = "", onClick }) {
	...
	return /* @__PURE__ */ jsxs(PageContainer, { children: [
		/* @__PURE__ */ jsxs(Paragraph, { children: [
			...
			/* @__PURE__ */ jsxs("p", { children: [
				...
				/* @__PURE__ */ jsx(Link, {
					to: "https://drive.google.com/file/d/19WE5z87FSaUzhyZCCcRBgiPe-JOP1oOT/view?usp=sharing",
					target: "_blank",
					className: "color-primary underline",
					onClick: () => posthog?.capture("talk_link_clicked"),
					children: "talk"
				}),
				"."
			] })
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx(InfoCard, {
					...
					text: /* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsx("p", { children: "Took full ownership of the frontend from early stages not just building features but making architectural decisions, setting standards, and keeping the codebase maintainable as the product scaled." }),
							/* @__PURE__ */ jsx("p", { children: "The impact that mattered most: an 80% improvement in Core Web Vitals, real-time analytics integrated end to end, and a deployment pipeline that actually gave the team confidence to ship." }),
							/* @__PURE__ */ jsxs("p", { children: [/* @__PURE__ */ jsx("b", { children: "Stack:" }), " Next.js · Redux · TypeScript · TailwindCSS · Node.js · Docker · Nginx · AWS S3 · Axios · Winston"] })
						]
					})
				}), /* @__PURE__ */ jsx(InfoCard, {
					direction: "col",
					...
					text: /* @__PURE__ */ jsxs("div", {
						className: "flex flex-col gap-2",
						children: [
							/* @__PURE__ */ jsx("p", { children: "Built both the frontend and backend for a meeting and collaboration platform designed the API layer in Express, wired up PostgreSQL with Sequelize ORM, and delivered the full React frontend with role-based access control and a BlueJeans API integration for in-app meeting scheduling." }),
							/* @__PURE__ */ jsx("p", { children: "Early in my career but one of the first times I saw the full picture from database to UI and understood how decisions on one end ripple through the other." }),
							/* @__PURE__ */ jsxs("p", { children: [/* @__PURE__ */ jsx("b", { children: "Stack:" }), " React · Redux · Express · Node.js · PostgreSQL · Material UI · AWS S3 · Sequelize ORM · Heroku"] })
						]
					})
				})]
			})
				...
				children: [/* @__PURE__ */ jsx("img", {
					...
					children: [/* @__PURE__ */ jsxs("p", { children: [
						...
						/* @__PURE__ */ jsx(Link, {
							...
							target: "_blank",
							className: "color-primary underline",
							onClick: () => posthog?.capture("github_source_clicked"),
							children: "code"
						}),
						"."
