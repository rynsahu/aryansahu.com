...
async function hydrate() {
  const modules = {
    "about": () => import('./about-DgyHej7o.js'),
    "index": () => import('./index-CVk1Oqw8.js'),
    "postsfirstpost": () => import('./first-post-BP-sH6ra.js'),
    "postssecoundpost": () => import('./secound-post-PS6GSmiU.js')
  };
  const moduleName = getFileNameFromPathmame();
  const module = await modules[moduleName]();
  const Content = module.content;
  const rootElement = document.querySelector('main');
  clientExports.hydrateRoot(rootElement, /*#__PURE__*/React.createElement(Content, null));
}
